            ...
            <div className="c-container">
                ...
                <div className="lg:hidden mt-[100px] flex flex-col">
                    ...
                    <div className="flex mt-8 gap-x-4">
                        <Link className="icon-wrapper flex justify-center items-center text-white rounded-[50%] p-4 bg-[#1B1B1B] w-14 h-14 xl:w-16 xl:h-16" href={contacts.vk}
                              target="_blank">
                        ...
                        <Link className="icon-wrapper flex justify-center items-center text-white rounded-[50%] p-4 bg-[#1B1B1B] w-14 h-14 xl:w-16 xl:h-16" href={contacts.telegram} target="_blank">
                            <svg width="24" height="24" className="duration-200" viewBox="0 0 24 24"
                                 fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div className="grid grid-cols-1 gap-y-20 md:grid-cols-2 md:gap-x-8 xl:grid-cols-4">
                        ...
                        <div className="hidden xl:flex xl:flex-col">
                            ...
                            <Link
                                ...
                                href={'mailto:' + contacts.email}>{contacts.email}</Link>
                            <div className="flex mt-8 gap-x-4">
                                <Link className="icon-wrapper flex justify-center items-center text-white rounded-[50%] p-4 bg-[#1B1B1B] w-14 h-14 xl:w-16 xl:h-16"
                                      href={contacts.vk}
                                      target="_blank">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         className="duration-200"
                                ...
                                <Link className="icon-wrapper flex justify-center items-center rounded-[50%] p-4 bg-[#1B1B1B] w-14 h-14 xl:w-16 xl:h-16" href={contacts.telegram}
                                      target="_blank">
